...
public class InstructionTester {
	...
	public void testCPYN1(){
		Instruction instr = machine.get(0x1E);
		int arg = 700;
		instr.execute(arg);		
	}
	
	@Test 
	public void testCPYN2(){
		Instruction instr = machine.get(0x1E);
		machine.setData(0, 3);
		int num = machine.getData(0);
		
		Instruction instr2 = machine.get(0x1D);
		machine.setData(0, 1);
		machine.setData(1, 2);
		machine.setData(2, 3);
		machine.setData(3, 6);
		...
		machine.setData(6, 8);
		machine.setData(7, 9);
		machine.setData(8, 10);
		machine.setData(9, 10);
		machine.setData(10, 3);
		
		instr2.execute(num);
		
		assertEquals(machine.getData(0),machine.getData(6));
		assertEquals(machine.getData(1),machine.getData(7));	
	...
	@Test (expected=IllegalArgumentException.class)
	//checks to see if COPY throws IllegalArgumentException 
	...
	public void testCOPY3(){
		...
		assertEquals(machine.getData(0),machine.getData(8));
		assertEquals(machine.getData(1),machine.getData(9));		
		assertEquals(machine.getData(2),machine.getData(10));	

	}	
	
	@Test //source > target
	public void testCOPYbackwards(){
		Instruction instr = machine.get(0x1D);
		machine.setData(0, 1);
		machine.setData(1, 2);
		machine.setData(2, 3);
	...
	@Test //source < target
	public void testCOPYoverlap(){
		Instruction instr = machine.get(0x1D);
		machine.setData(0, 1);
		machine.setData(1, 2);
		machine.setData(2, 3);
		
		machine.setData(10, 1);
		machine.setData(11, 2);
		machine.setData(12, 2);
		
		instr.execute(10);
		
		assertEquals(machine.getData(0),machine.getData(10));
		assertEquals(machine.getData(1),machine.getData(11));
		assertEquals(machine.getData(2),machine.getData(12));
	}
